...
with st.sidebar:
    ...
    sample_data = {
        ...
        'Data_Transferred_MB': st.number_input('Data Transferred (MB)', min_value=0.0, step=0.1),
        ...
        'Call_Direction': st.selectbox('Call Direction', ['Incoming', 'Outgoing']),
...
st.subheader('Predicted Allocated Bandwidth (MB):')

predicted_value_html = f"""
    <p style="font-size: 20px; color: blue; font-weight: bold;">
        {predicted_bandwidth[0]:.2f} MB
    </p>
"""
